...
namespace Hatfield.EnviroData.Core
{
    ...
    public partial class TaxonomicClassifierExternalIdentifier
    {
        public int BridgeID { get; set; }
        public int TaxonomicClassifierID { get; set; }
        public int ExternalIdentifierSystemID { get; set; }
        public string TaxonomicClassifierExternalIdentifier1 { get; set; }
        public string TaxonomicClassifierExternalIdentifierURI { get; set; }
